...
export const Description: FC<DescriptionProps> = () => {
  ...
  const descriptionList = [
    {
      id: 0,
      title: 'Предостовляем общирный каталог автомобилей',
      description:
        'Даём возможность ознакомиться с каталогом автомобилей разных автомобильных диллеров'
    },
    {
      id: 1,
      title: 'Обрабатываем вашу заявку на бронирование',
      description: 'После того как вы забронируете машину на нашем сервисе, мы моментально свяжимся с диллером и забронируем машину у него в сервисе'
    },
    {
      id: 2,
      title: 'Ждать звонка!',
      description: 'Вам позвонят сразу же как машина будет готова к вашему приезду, остаёься только приехать к диллеру и оплатить машину!'
    }
  ];
  return (
